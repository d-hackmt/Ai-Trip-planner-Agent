...
# tracking msg generated by ai and human / user
from langchain_core.messages import HumanMessage,AIMessage
from src.chains.itinerary_chain import generate_itineary

# lets import custuom logger and exceptions
...
class TravelPlanner:
    def __init__(self):
        ...
        # user and ai conversation history , like a reducer
        # each function below will be appending here
        self.messages=[]
        
        
        ## --------------------------
        
        ## user input city and intrests
        # one city many intrests
        self.city=""
        # list of string
        self.interests=[]
    ...
    def set_city(self,city:str):
        ...
        # fetching city from user and
        # handling custom exception if user did not give city
        # eg : delhi
    ...
    def set_interests(self,interests_str:str):
        ...
        # fetching intrests from user and 
        # handling custom exception if user did not give intrests
        
        # eg : Red fort , Qutubminar , lotus temple
        # we are telling user please give intrests in comma seperated strings
    ...
    def create_itineary(self):
        ...
        ## generating response by AI 
        # given city and intrests from user
